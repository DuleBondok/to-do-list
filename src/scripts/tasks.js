...
export const buildingTasks = () =>
{
    ...
    let task2 = new Task("Go to the beach", "mediumPriority", "2024-07-20", "Vacation");
        ...
        tasksList.forEach((task) => {
            ...
            editTaskBtn.addEventListener("click", () => {
                ...
                editTaskFormEditBtn.addEventListener("click", () => {
                    if(!editTaskInput.value || !editTaskPriorityInput.value || !editTaskScheduleSelect.value)
                    {
    ...
    function addTask()
        {
            ...
            taskButton.addEventListener("click", (e) => {
                ...
                if(!titleValue || !taskPriority || taskSchedule || projectChoice)
                {
                    ...
                    const task5 = new Task(titleValue, taskPriority, taskSchedule, projectChoice);
                    addTaskToList(task5);
                    displayTasks();
